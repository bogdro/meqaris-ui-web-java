...
public class ResourcesReservationsControllerRestTest extends IntegrationTestBase {
	...
	public void testFullList() {
		...
		List<Map<String, Object>> r = cc.getForObject(
				"http://localhost:" + port + "/reservations?file=" + dir, List.class);
		assertNotNull(r);
	}
	...
	public void testFirst() throws Exception {
		...
		ResponseEntity<MeqResourceReservations> r = cc.getForEntity(
				new URI("http://localhost:" + port + "/reservation/1?file=" + dir),
				MeqResourceReservations.class);
		assertNotNull(r);
	}
